...
(function($) {
    ...
    for (var i = 0; i < 60; i++) {
        var j = (i < 10)? "0":"";
        str_opt_mih += "<option value='"+i+"'>" + i + "分</option>\n";
    }
    ...
    for (var i = 0; i < 24; i++) {
        var j = (i < 10)? "0":"";
        str_opt_hid += "<option value='"+i+"'>" + i + "时</option>\n";
    }

    // options for days of month
    var str_opt_dom = "";
    for (var i = 1; i < 32; i++) {
        if (i == 1 || i == 21 || i == 31) { var suffix = "日"; }
        else if (i == 2 || i == 22) { var suffix = "日"; }
        else if (i == 3 || i == 23) { var suffix = "日"; }
        else { var suffix = "日"; }
    ...
    var str_opt_month = "";    
    for (var i = 0; i < 12; i++) {
        str_opt_month += "<option value='"+(i+1)+"'>" + (i + 1) + "月</option>\n";
    }
	...
	var periodValues = ["minute", "hour", "day", "week", "month", "year"];
    for (var i = 0; i < periods.length; i++) {
        str_opt_period += "<option value='"+periodValues[i]+"'>" + periods[i] + "</option>\n";
    }
