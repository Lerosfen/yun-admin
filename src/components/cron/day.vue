<template lang="html">
  <div :val="value_">
    <div>
      <el-radio v-model="type" label="1" size="mini" style="margin-top: 10px">每日</el-radio>
    </div>
    <div>
      <el-radio v-model="type" label="5" size="mini" style="margin-top: 10px">不指定</el-radio>
    </div>
    <div>
      ...
      <div class="input-tpm blue-input"><el-input-number controls-position="right" @change="type = '2'" v-model="cycle.end" :min="2" :max="31" size="mini" style="width: 100px;"></el-input-number>
      日</div> 
    </div>
    <div>
      ...
      <span style="margin-left: -70px; margin-right: 5px;">日开始，每</span>
      <div class="input-tpm blue-input">
      ...
      <span style="margin-left: -70px">日执行一次</span> 
    </div>
    <div>
      <el-radio v-model="type" label="8" size="mini" style="margin-top: 10px">工作日</el-radio>
    ...
    <div>
      <el-radio v-model="type" label="6" size="mini" style="margin-top: 10px">本月最后一天</el-radio>
    </div>
    <div>
