<template lang="html">
  <div :val="value_">
    <div>
      <el-radio v-model="type" label="1" size="mini" style="margin-top: 10px">每月</el-radio>
    </div>
    <div>
    ...
    <div>
      ...
      <span style="margin-left: 10px; margin-right: 5px;">从</span>
      <div class="input-tpm blue-input">
      <el-input-number controls-position="right" @change="type = '3'" v-model="loop.start" :min="1" :max="12" size="mini" style="width: 100px;"></el-input-number>
      </div>
      <span style="margin-left: -70px; margin-right: 5px;">月开始，每</span>
      <div class="input-tpm blue-input">
      <el-input-number controls-position="right" @change="type = '3'" v-model="loop.end" :min="1" :max="12" size="mini" style="width: 100px;"></el-input-number>
      </div>
      <span style="margin-left: -70px">月执行一次</span>
