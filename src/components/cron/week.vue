<template lang="html">
  <div :val="value_">
    <div>
      <el-radio v-model="type" label="1" size="mini" style="margin-top: 10px">每周</el-radio>
    </div>
    <div>
    ...
    <div>
      ...
      <span style="margin-left: -70px; margin-right: 5px;">至星期</span>
      <div class="input-tpm blue-input">
    ...
    <div>
      ...
      <span style="margin-left: -70px; margin-right: 5px;">开始，每</span>
      <div class="input-tpm blue-input">
      ...
      <span style="margin-left: -75px">天执行一次</span>
      
    </div>
    <div>
      <el-radio v-model="type" label="7" size="mini" style="margin-top: 10px">指定周</el-radio>
      ...
      <span style="margin-left: -70px; margin-right: 5px;">周，星期</span>
      <div class="input-tpm blue-input" style="margin-left: -6px">
    ...
    <div>
      <el-radio v-model="type" label="6" size="mini" style="margin-top: 10px">本月最后一个</el-radio>
