<template>
  <div class="list-container shadow">
    ...
    <div class="content-section">
          ...
          <el-col :span="10" :offset="2" style="margin-left: 77px">
            <div class="grid-content bg-purple collectionData">
              <el-form-item label="英文名称" prop="enName">
                <div class="input-tpm blue-input new-input">
                  <el-input disabled placeholder="请输入表英文名称" v-model="form.enName"></el-input>
                </div>
              </el-form-item>
            </div>
          </el-col>
          ...
          <el-col :span="10" :offset="2" style="margin-left: 77px">
            <div class="grid-content bg-purple collectionData">
              <el-form-item label="所属基础库" prop="belongSto">
                <div class="input-tpm blue-input new-input">
                  <el-select disabled placeholder="请选择基础库" v-model="form.belongSto">
                    <el-option
        ...
        <!-- <div style="margin-top: -20px">
          <el-col :span="6" :offset="3">
            <div class="input-tpm blue-input">
              <el-input placeholder="请选择元数据模板" v-model="iptTplName" class="clean_input" disabled></el-input>
            </div>
          </el-col>
          <el-col :span="6">
            <el-button class="blue-btn fl choisetab" type="primary" @click="selMetaData()">选 择</el-button>
        </el-col>-->
        <el-col :span="6">
      ...
      <div class="table-container wordtable-container pag-position" style="margin-top:40px">
        <el-row>
    ...
    <yj-dialog
      title="选择元数据模板"
      :visible.sync="selMetaDataTplView"
      class="cha"
      width="55%"
        ...
        self.$refs.addFormRules.validate(valid => {
          if (!valid) {
            ...
            if (tbl.length == 0) {
              ...
              if (self.submitPKey == '') {
                delete EditParams.primarykeys;
              }
              api.updateByPrimaryKeySelective(EditParams)
                .then(res => {
