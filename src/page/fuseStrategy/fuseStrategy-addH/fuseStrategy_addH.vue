      ...
      <el-row>
        <el-col :span="21">
            ...
            <div class="table-container wordtable-container" style="margin-top: 20px">
              <el-row>
                <el-col :span="tableWidth" :offset="3">
                  <el-table stripe :data="cleanwords1" height="250" style="width: 100%">
                    <el-table-column
                    ...
                    ></el-table-column>
                    <el-table-column label="操作" align="center" v-if="showType != 1">
                      <template slot-scope="scope">
                        <div class="btnMove">
                          ...
                          <img
                            ...
                            height="40"
                            width="39"
                            :disabled="scope.$index===(cleanwords1.length-1)"
          ...
          <div class="fuseBtn" v-show="!this.qingxiWords ">
            ...
            <el-button v-show="showType==0" class="blue-btn" @click="goBack()">取消</el-button>
          ...
          >
            ...
            <div class="table-container addtable-container" style="margin-top: 0">
              <el-table
                :data="tableDatas"
                style="width: 100%"
...
export default {
  ...
  methods: {
    ...
    //选择行融合表确定；
    liebiaoSubmit() {
      this.cleanwords1 = this.currentSelection;
      this.qingxiList = false;
    },
